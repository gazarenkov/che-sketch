...
public class MachineConfig2Impl implements MachineConfig2 {
    ...
    public MachineConfig2Impl(MachineConfig2 machine) {
    ...
    public MachineConfig2Impl withAgents(List<String> agents) {
        this.agents = agents;
        return this;
    }
    ...
    public MachineConfig2Impl withServers(Map<String, ServerConf2Impl> servers) {
        this.servers = servers;
        return this;
    }
    ...
    public MachineConfig2Impl withAttributes(Map<String, String> attributes) {
        this.attributes = attributes;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MachineConfig2Impl)) {
            return false;
        }
        final MachineConfig2Impl that = (MachineConfig2Impl)obj;
