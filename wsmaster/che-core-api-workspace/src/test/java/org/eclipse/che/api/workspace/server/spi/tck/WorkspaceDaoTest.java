...
public class WorkspaceDaoTest {
    ...
    public void shouldUpdateWorkspace() throws Exception {
        ...
        final MachineConfig2Impl existingMachine = defaultEnv.getMachines().get(machineNames.get(1));
    ...
    public static WorkspaceConfigImpl createWorkspaceConfig(String name) {
        ...
        env2.setMachines(new HashMap<>(ImmutableMap.of("machine1", new MachineConfig2Impl(exMachine1),
                                                       "machine3", new MachineConfig2Impl(exMachine3))));
